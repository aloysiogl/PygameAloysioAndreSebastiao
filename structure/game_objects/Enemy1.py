...
class Enemy1(GameObject):
    ...
    def __init__(self, initial_pos):
        ...
        self.mesh = PolygonalMesh([Vector2(0,-240), Vector2(30,-200), Vector2(30, 200), Vector2(0,260), Vector2(-30,200),
                                   Vector2(-30,-200), Vector2(0,-240)], Material(Color.green))


        self.mesh2 = PolygonalMesh([Vector2(0,220), Vector2(20,220), Vector2(400,0), Vector2(-400,0), Vector2(-20,220),
                                    Vector2(0,220)], Material(Color.yellow))
        self.mesh3 = PolygonalMesh([Vector2(300, 120), Vector2(270, 120), Vector2(270, -20), Vector2(300,-20),
                                    Vector2(300,120)], Material(Color.green))
