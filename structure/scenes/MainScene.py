...
main_scene = Scene([player, EnemyGenerator(), ReverseStarCreator(), LifeBar(Vector2(0, 0), player), MainController() , BlackWrap(Vector2(0, 0)), BlackLayer(Vector2(0, 0))], Material(Color.black))
