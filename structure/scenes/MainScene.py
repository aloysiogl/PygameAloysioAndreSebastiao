...
main_scene = Scene([BlackLayer(Vector2(0, 0)), player, EnemyGenerator(), ReverseStarCreator(), LifeBar(Vector2(0, 0), player), MainController() , BlackWrap(Vector2(0, 0)), CurrentScore(Vector2(320, 8))], Material(Color.black))
