...
from structure.game_objects.main_objects.PowerBar import PowerBar
...
main_scene = Scene([player, EnemyGenerator(), ReverseStarCreator(), LifeBar(Vector2(0, 0), player), MainController()
                       , PowerBar(Vector2(340, 0), player), BlackWrap(Vector2(0, 0)), BlackWrap(Vector2(340, 0))], Material(Color.black))
